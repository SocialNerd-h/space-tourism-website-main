...
const App = () => {
  ...
  return (
    <div className="h-screen lg:bg-homeLg md:bg-homeMd sm:bg-homeSm bg-cover bg-center">
      <header className="flex justify-between items-center  sm:mx-5 h-[5.6875rem]">
        <img
          src={logo}
          className="h-12 w-12 md:ml-[2.5rem] sm:h-10 sm:w-10 my-5"
        ></img>
        <img
          src={menu}
          alt="menu-button"
        ...
        />
        <nav
          className={`md:w-5/6 md:h-24 md:bg-white/5 md:backdrop-blur font-barlowC ${isOpen ? "translate-x-0" : "translate-x-full"} md:translate-x-0 sm:fixed sm:z-50 sm:top-0 sm:pt-8 sm:right-0 sm:w-8/12 sm:bg-veryDarkNavy sm:bg-opacity-50 sm:backdrop-blur sm:h-dvh `}
        >
          <img
            src={exit}
            onClick={() => setOpen(!isOpen)}
          ...
          />
          <ul className="md:flex md:font-light md:h-24 md:items-center md:justify-between md:pl-[5.4375rem] md:pr-10 text-white sm:pt-28 sm:ml-8 uppercase tracking-widest [word-spacing:0.5rem]">
            <li
      ...
      <div className="text-white flex sm:flex-col md:flex-col sm:mx-5 items-center sm:mt-7 md:mx-32">
        <div className="flex flex-col items-center md:mt-[7.5rem]">
