...
const HomeHero = () => {
  return (
    <div className="min-h-dvh pt-[100px] lg:pt-[136px] flex flex-col lg:bg-homeLg md:bg-homeMd sm:bg-homeSm bg-no-repeat bg-cover bg-fixed bg-center">
      <div className="text-white lg:mx-auto lg:my-auto lg:h-[39.5rem] lg:w-[69.375rem] lg:justify-between flex sm:flex-col md:flex-col sm:mx-5 items-center sm:mt-7 md:mx-32 ">
          <div className="flex flex-col lg:items-start lg:w-[50%] items-center md:mt-[7.5rem] ">
            ...
            <Link className=" flex justify-center mb-4 items-center sm:mt-[4.46875rem] outline outline-white/0 duration-700 hover:outline-white/10 outline-[87px]
          ...
          md:text-[2rem]" to="/destination">Explore</Link>
        </div>
    </div>
  )
}
