...
const PlanetHero = () => {
  ...
  return (
    <div className="text-white sm:w-[327px] lg:w-[1440px] lg:h-[45.875rem] lg:mx-auto sm:mx-auto md:m-[2.5rem] md:max-w-[1220px] md:mx-auto lg:py-[2.5rem] lg:px-[10.3125rem] flex flex-col items-center">
        <div className="font-barlowC uppercase lg:text-[1.75rem] md:text-xl self-start [letter-spacing:0.15em;]" >
        ...
        <div className="sm:w-full lg:mt-[9.4375rem] lg:minHeight:mt-28 lg:flex">
            ...
            <div className="flex flex-col lg:px-12  sm:mt-12 md:mt-[4.125rem] md:min-w-[32.125rem] lg:text-left md:px-32 lg:w-[50%] items-center max-w-3xl">
                ...
                <div className="font-bellefair sm:text-[3.5rem] md:text-[5rem] uppercase" >{destination.name}</div>
                <div className="sm:text-[0.9375rem] pb-6 border-b-[1px] border-white/50 sm:mt-4 font-barlow text-center text-lightBlue">{destination.description}</div>
                <div className="flex md:w-full md:mt-6 md:justify-between sm:flex-col  md:item sm:pt-6 sm:text-[1.5rem] sm:text-center uppercase font-bellefair">
                    <div className="flex md:w-[50%] flex-col md:items-center md:text-[1.75rem]"><span className="font-barlowC text-sm text-lightBlue">avg. distance</span> {destination.distance} </div>
                    <div className="flex md:w-[50%] flex-col md:items-center md:text-[1.75rem] sm:pt-6"><span className="font-barlowC text-sm text-lightBlue">est. travel time</span>{destination.travel}</div>
                </div>
            </div>
        </div>
    </div>
