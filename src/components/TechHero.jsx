        ...
        <div id="container" className="text-white h-full md:max-w-[840px] lg:w-[88.5%] flex flex-col items-center">
            ...
            <div className="lg:flex lg:h-[734px] lg:items-center lg:flex-row-reverse ">
                <div className="sm:w-full md:hidden sm:h-[258px] lg:w-[50%] flex flex-col lg:items-end items-center relative sm:overflow-hidden" >
                    ...
                    <img className="sm:object-top sm:absolute sm:max-w-[420px] sm:mx-auto sm:bottom-[-50px] lg:w-[600px] lg:h-[600px] sm:object-cover" src={crew.images? crew.images.portrait: null} alt="" />
                    )}
                </div>
                <div className="w-full sm:hidden lg:hidden md:h-[357px] flex flex-col justify-center items-center relative overflow-hidden" >
                    {loading ? <Spinner loading={loading} /> : (
                    <img className="object-top absolute max-w-[768px] mx-auto object-cover" src={crew.images? crew.images.landscape: null} alt="" />
                    )}
                </div>
                    ...
                    <div className="md:px-[5rem] h-full md:max-w-[780px] flex lg:flex-row items-center flex-col">
                        <div className="sm:max-w-[350px] h-full lg:mr-16 lg:w-fit w-full">
                            <ul className="flex lg:flex-col h-full justify-between md:px-[9.75rem] sm:min-w-[310px] sm:px-[5.4rem]">
                                <li><a id='0' className="border-[1px] border-white/50 rounded-[50%] flex justify-center items-center transition duration-700 hover:border-white md:text-2xl lg:size-[5rem] lg:text-[2rem] md:size-[3.5rem] sm:size-10 " onClick={() => {setId(0)}}  href="">1</a></li>
                                <li><a id='1' className="border-[1px] border-white/50 rounded-[50%] flex justify-center items-center transition duration-700 hover:border-white md:text-2xl lg:size-[5rem] lg:text-[2rem] md:size-[3.5rem] sm:size-10 " onClick={() => {setId(1)}}  href="">2</a></li>
                                <li><a id='2' className="border-[1px] border-white/50 rounded-[50%] flex justify-center items-center transition duration-700 hover:border-white md:text-2xl lg:size-[5rem] lg:text-[2rem] md:size-[3.5rem] sm:size-10 " onClick={() => {setId(2)}}  href="">3</a></li>
                            </ul>
                        </div>
                        <div className=" flex flex-col lg:items-start items-center">
                            ...
                            <div className="font-bellefair sm:mt-4 sm:text-2xl md:my-4 lg:text-[3.5rem] md:text-[2.5rem] uppercase" >{crew.name}</div>
                            <div className="sm:text-[0.9375rem] sm:mt-4 lg:text-[1.125rem] lg:text-left leading-8 font-barlow text-center text-lightBlue">{crew.description}</div>
                        </div>
                    </div>
                </div>
            </div>
