...
const CrewPage = () => {
  ...
  return (
    <div id="container" className="text-white relative sm:w-[327px] lg:w-[1440px] lg:h-[45.875rem] lg:mx-auto sm:mx-auto sm:py-6 md:p-[2.5rem] md:max-w-[1220px] md:mx-auto lg:py-[2.5rem] lg:px-[10.3125rem] flex flex-col items-center">
        ...
        <div className="sm:w-full  lg:mt-8 lg:flex ">
            <div className="flex flex-col sm:mt-16 md:mt-[4.125rem] md:max-w-[32.125rem] lg:w-[50%] lg:mt-32 items-start justify-center">
                ...
                <div className="w-full font-barlowC sm:text-sm lg:pr-[23.4rem] lg:mt-[14.8rem]  uppercase tracking-widest text-lightBlue">
                    <ul className="flex flex-row md:px-[13.25rem] h-[2.25rem] sm:px-[7.5rem]  justify-between">
                        <li><a className="size-[10px] rounded-[50%] lg:size-[15px] inline-block transition duration-700 bg-white/20 hover:bg-white/50" onClick={() => {setId(0)}}  href=""></a></li>
                        <li><a className="size-[10px] rounded-[50%] lg:size-[15px] inline-block transition duration-700 bg-white/20 hover:bg-white/50" onClick={() => {setId(1)}}  href=""></a></li>
                        <li><a className="size-[10px] rounded-[50%] lg:size-[15px] inline-block transition duration-700 bg-white/20 hover:bg-white/50" onClick={() => {setId(2)}}  href=""></a></li>
                        <li><a className="size-[10px] rounded-[50%] lg:size-[15px] inline-block transition duration-700 bg-white/20 hover:bg-white/50" onClick={() => {setId(3)}}  href=""></a></li>
                    </ul>
                </div>
            </div>
                <div className="md:mt-4 sm:mt-[2rem] lg:w-[50%] md:overflow-hidden flex justify-center relative before:absolute before:w-full before:h-[50px] before:bottom-0 before:bg-gradient-to-t 
                    from-[#0B0D17] to-[rgb(217,217,217)]/0">
                    {loading ? <Spinner loading={loading} /> : (
                    <img className=" sm:h-[340px]  md:h-[35rem] lg:h-[42.25rem]" src={crew.images? crew.images.png : null} alt="" />
                    )}
                </div>
        </div>
    </div>
...
background: linear-gradient(180deg, #D9D9D9 77.39%, rgba(217, 217, 217, 0) 100%);
